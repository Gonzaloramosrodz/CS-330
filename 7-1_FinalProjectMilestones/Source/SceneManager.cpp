...
{
	// Enable lighting and texture usage
	m_pShaderManager->setBoolValue("bUseLighting", true);
	m_pShaderManager->setBoolValue("bUseTexture", true);

	// Set up Light Source 0
	m_pShaderManager->setVec3Value("lightSources[0].position", glm::vec3(5.0f, 5.0f, 5.0f));
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", glm::vec3(0.2f, 0.2f, 0.2f));
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", glm::vec3(0.7f, 0.7f, 0.7f));
	...
	// Provide static camera position (adjust if camera is dynamic)
...
void SceneManager::RenderScene()
{
	...
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1, 0, 1, 1); // magenta
